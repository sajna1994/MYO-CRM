...
const [customerId, setCustomerId] = useState('walk-in');  const [phone, setPhone] = useState('');
...
const handleCreateCustomer = async (values) => {
  ...
  try {
    ...
    // Add new customer to current customer list
...
/>
  ...
  options={products.map((product) => ({
    value: product._id,
    label: `${product.name} - ₹${getProductPrice(
      product
